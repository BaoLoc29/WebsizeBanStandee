...
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE X CƯỜNG LỰC', N'Chân treo Poster chữ X sang trọng', 7, 160000, 'Content/images/STANDEECL.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE CUỐN INOX', N'Chân Standee hộp cuốn Inox sáng màu', 8, 280000, 'Content/images/STANDEEINOX.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'CHÂN KỆ ĐỰNG TÀI LIỆU', N'Kệ đựng tài liệu kích thước A3 - A4', 2, 1900000, 'Content/images/CATALOGUE.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE ĐẾ NƯỚC CỬA', N'Standee khung cửa đế nước thẩm mỹ cao', 4, 250000, 'Content/images/STANDEECUADENUOC.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
...
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE CUỐN NHÔM', N'Standee chân cuốn cao cấp trong nhà', 8, 260000, 'Content/images/CUONNHOM.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE X TĂNG GIẢM', N'Standee tăng giảm kích thước trưng bày', 6, 110000, 'Content/images/XTANGGIAM.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE T TĂNG GIẢM', N'Standee khung cửa đế sắt trong nhà', 3, 200000, 'Content/images/STANDEET.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE KHUNG SẮT', N'Standee chân sắt trưng bày ngoài trời', 4, 910000, 'Content/images/STANDEECHANSAT.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE CỬA ĐÉ SẮT', N'Standee khung cửa đế sắt trong nhà giá rẻ', 3, 280000, 'Content/images/STANDEEKHUNGCUA.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE X ĐẾ NƯỚC', N'Standee đế nước tăng giảm hai mặt cao cấp', 4, 410000, 'Content/images/STANDEEDENUOC.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'BACKDROP SÂN KHẤU', N'Backdrop sân khấu di động kiểu dáng mạng nhện', 5, 4100000, 'Content/images/BACKDROP.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE KHUNG NHÔM', N'Standee khung nhôm đế sắt kích thước hai mét', 4, 720000, 'Content/images/STANDEEKHUNGNHOM.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE CHỮ X THƯỜNG', N'Standee treo poster chữ X loại thường giá rẻ', 6, 50000, 'Content/images/STANDEEXTHUONG.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE MENU CHỮ A', N'Bảng chỉ dẫn chữ A nhôm một mặt hoặc hai mặt', 2, 780000, 'Content/images/STANDEEA.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE MENU CHỮ H', N'Standee tăng giảm kiểu chữ H sang trọng', 7, 320000, 'Content/images/STANDEEH.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE MENU SẮT', N'Standee menu quán ăn nhà hàng, bảng chỉ dẫn', 7, 263000, 'Content/images/STANDEEXAYGOC.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE HÀO HOA NHÔM', N'Standee hào hoa đế to chất liệu nhôm siêu bền', 8, 430000, 'Content/images/STANDEEHAOHOANHOM.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE X MINI ĐỂ BÀN', N'Standee chữ X mini size A4 để bàn giá cực sốc', 6, 25000, 'Content/images/STANDEEXMINI.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
    values (N'STANDEE HÀO HOA NHỰA', N'Standee hào hoa nhựa trưng bày showroom cao cấp', 8, 430000, 'Content/images/STANDHAOHOANHUA.png')
Insert into Product (NamePro, DecriptionPro, CateID, Price, ImagePro)
